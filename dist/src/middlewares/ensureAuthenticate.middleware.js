...
export default function ensureAuthenticate(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var authorization, token, JWT_SECRET_KEY, userId, user, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    userId = jwt.verify(token, JWT_SECRET_KEY).userId;

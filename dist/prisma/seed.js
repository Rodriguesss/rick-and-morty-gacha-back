...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.profileIcon.createMany({
                        data: [
                            {
                                name: "Rick Sanchez",
                                cursor1: "../public",
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, prisma.banners.createMany({
                            data: [
                                {
                                ...
                                },
                                {
                                    ...
                                    description: "Esse portal invoca apenas seres curiosos! Claro, se você for um terraqueo!",
                                ...
                                {
                                    title: "Perdidos na dimensão A-31",
                                    description: "Esse portal.. beep-pop.. invoca apenas.. be-poop.. robos.. bee-oop.",
